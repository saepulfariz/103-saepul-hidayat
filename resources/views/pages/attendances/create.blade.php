        ...
        <div class="col-12">
            <div class="row mt-2">
                ...
                <div class="col-sm-6 text-end">
                    <a href="{{ route('attendances.index', $meeting['id']) }}" class="btn btn-secondary me-2"><i
                            class="fas fa-arrow-left"></i>
                        BACK</a>
                </div>
            </div>
            <form action="{{ route('attendances.store', $meeting['id']) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body  pb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-control @error('date') is-invalid @enderror" name="member_id"
                                        id="member_id">
