...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('meetings.update', $data['id']) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                            ...
                            <div class="card-body  pb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" id="title" value="{{ old('title', $data['title']) }}">
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        name="date" id="date" value="{{ old('date', $data['date']) }}">
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="time"
                                                ...
                                                id="end_time" value="{{ old('end_time', $data['end_time']) }}">
                                        </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror"
                                        name="location" id="location" value="{{ old('location', $data['location']) }}">
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control @error('recapitulation') is-invalid @enderror" name="recapitulation" id="recapitulation"
                                        cols="30" rows="5">{{ old('recapitulation', $data['recapitulation']) }}</textarea>
                                </div>
