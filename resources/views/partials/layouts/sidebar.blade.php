<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/dashboard" target="_blank">
        <img src="{{ asset('assets/uploads/organizations/' . session()->get('organization')['logo']) }}"
            class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">{{ session()->get('organization')['shortname'] }}
            {{ session()->get('organization')['year'] }}</span>
    </a>
</div>
